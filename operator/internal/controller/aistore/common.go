...
func (*Reconciler) isStatefulSetFullyReady(desiredSize int32, ss *appsv1.StatefulSet) bool {
	specReplicas := *ss.Spec.Replicas
...
func (r *Reconciler) isStatefulSetReady(ss *appsv1.StatefulSet, desired, minReady int32, autoScaling bool) bool {
