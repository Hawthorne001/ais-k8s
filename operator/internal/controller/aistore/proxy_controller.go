...
func (r *Reconciler) ensureProxyPrereqs(ctx context.Context, ais *aisv1.AIStore) (err error) {
...
func (r *Reconciler) initProxies(ctx context.Context, ais *aisv1.AIStore) (ctrl.Result, error) {
	var (
		err     error
		exists  bool
		changed bool
...
func (r *Reconciler) handleProxyState(ctx context.Context, ais *aisv1.AIStore) (result ctrl.Result, err error) {
...
func (r *Reconciler) isProxyStatefulSetReady(ais *aisv1.AIStore, ss *appsv1.StatefulSet) bool {
	return r.isStatefulSetReady(ss, ais.GetProxySize(), ais.GetMinReadyProxies(), ais.IsProxyAutoScaling())
}

func (r *Reconciler) handleProxyScale(ctx context.Context, ais *aisv1.AIStore, ss *appsv1.StatefulSet) error {
...
func (r *Reconciler) syncProxyPodSpec(ctx context.Context, ais *aisv1.AIStore, ss *appsv1.StatefulSet) (updated bool, err error) {
...
func (r *Reconciler) syncProxyPVCRetentionPolicy(ctx context.Context, ais *aisv1.AIStore, ss *appsv1.StatefulSet) (updated bool, err error) {
...
func (r *Reconciler) handleProxyRollout(ctx context.Context, ais *aisv1.AIStore, ss *appsv1.StatefulSet) error {
...
func (r *Reconciler) setHighestPodAsPrimary(ctx context.Context, ais *aisv1.AIStore, ss *appsv1.StatefulSet) (err error) {
	logger := logf.FromContext(ctx).WithValues("statefulset", ss.Name)
...
func (r *Reconciler) resetSSPartition(ctx context.Context, ss *appsv1.StatefulSet) (err error) {
	logger := logf.FromContext(ctx).WithValues("statefulset", ss.Name)
...
func (r *Reconciler) setPrimaryTo(ctx context.Context, ais *aisv1.AIStore, podIdx int32) error {
...
func (r *Reconciler) createProxyExternalService(ctx context.Context, ais *aisv1.AIStore) error {
...
func (r *Reconciler) proxyExternalSvcReady(ctx context.Context, ais *aisv1.AIStore) (ready bool, err error) {
