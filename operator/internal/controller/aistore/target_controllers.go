...
func (r *Reconciler) ensureTargetPrereqs(ctx context.Context, ais *aisv1.AIStore) (err error) {
...
func (r *Reconciler) initTargets(ctx context.Context, ais *aisv1.AIStore) (result ctrl.Result, err error) {
	// Deploy statefulset
...
func (r *Reconciler) reconcileTargetPDB(ctx context.Context, ais *aisv1.AIStore) error {
...
func (r *Reconciler) cleanupTarget(ctx context.Context, ais *aisv1.AIStore) (updated bool, err error) {
	return cmn.AnyFunc(
...
func (r *Reconciler) cleanupTargetSS(ctx context.Context, ais *aisv1.AIStore) (anyUpdated bool, err error) {
...
func (r *Reconciler) handleTargetState(ctx context.Context, ais *aisv1.AIStore) (result ctrl.Result, err error) {
...
func (r *Reconciler) syncTargetPodSpec(ctx context.Context, ais *aisv1.AIStore, ss *appsv1.StatefulSet) (updated bool, err error) {
	logger := logf.FromContext(ctx)
...
func (r *Reconciler) syncTargetPVCRetentionPolicy(ctx context.Context, ais *aisv1.AIStore, ss *appsv1.StatefulSet) (updated bool, err error) {
...
func (r *Reconciler) handleTargetRollout(ctx context.Context, ais *aisv1.AIStore, ss *appsv1.StatefulSet) (ctrl.Result, error) {
	logger := logf.FromContext(ctx)
...
func (r *Reconciler) prepareTargetForRollout(ctx context.Context, ais *aisv1.AIStore, podName string) (requeue bool, err error) {
	logger := logf.FromContext(ctx)
...
func (r *Reconciler) createTargetExternalServices(ctx context.Context, ais *aisv1.AIStore) error {
...
func (r *Reconciler) targetExternalSvcReady(ctx context.Context, ais *aisv1.AIStore) (ready bool, err error) {
	logger := logf.FromContext(ctx)
